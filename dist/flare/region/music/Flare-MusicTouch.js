...
},{"../internal/baseIndexOf":2,"../internal/getLength":5,"../internal/isIterateeCall":10,"../internal/isLength":11,"../lang/isArray":15,"../lang/isString":19,"../object/values":23}],2:[function(require,module,exports){
...
},{"../lang/isArguments":14,"../lang/isArray":15,"../object/keysIn":22,"./isIndex":9,"./isLength":11}],14:[function(require,module,exports){
...
},{"../internal/getNative":6,"../internal/isArrayLike":8,"../internal/shimKeys":13,"../lang/isObject":18}],22:[function(require,module,exports){
var isArguments = require('../lang/isArguments'),
    isArray = require('../lang/isArray'),
...
},{"../internal/isIndex":9,"../internal/isLength":11,"../lang/isArguments":14,"../lang/isArray":15,"../lang/isObject":18}],23:[function(require,module,exports){
...
},{"../internal/baseValues":4,"./keys":21}],24:[function(require,module,exports){
'use strict';

var _createClass = (function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; })();

var _music_handler = require('./system/handler/music_handler');

var _music_handler2 = _interopRequireDefault(_music_handler);
...
var FlarePlayMusicOnRegionTouch = (function () {
  function FlarePlayMusicOnRegionTouch() {
    _classCallCheck(this, FlarePlayMusicOnRegionTouch);
  }
  ...
  _createClass(FlarePlayMusicOnRegionTouch, null, [{
    ...
    value: function fadeOutOnRegions(regions, type, length) {
      ...
      if ((0, _isUndefined2.default)(length)) {
        length = 15;
      }
    ...
    value: function isMusicPlaying() {
      if ((0, _isUndefined2.default)(this._musicIsPlaying)) {
        return false;
      }
    ...
    value: function _setMusicHandlerInstance(musicClass) {
      if (musicClass instanceof _music_handler2.default) {
  ...
  return FlarePlayMusicOnRegionTouch;
})();

window.FlarePlayMusicOnRegionTouch = FlarePlayMusicOnRegionTouch;

},{"./system/handler/music_handler":25,"lodash/lang/isUndefined":20}],25:[function(require,module,exports){
'use strict';
