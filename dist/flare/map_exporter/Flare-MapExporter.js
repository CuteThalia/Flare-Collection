...
var MapExporter = (function () {
  function MapExporter() {
    _classCallCheck(this, MapExporter);
  }

  _createClass(MapExporter, null, [{
    key: 'exportCurrentMap',
    value: function exportCurrentMap(width, height) {
    ...
    key: '_currentMap',
    value: function _currentMap(stage, width, height) {
      var width = width;
      var height = height;
...
},{"../../node_modules/blueimp-canvas-to-blob/js/canvas-to-blob":1,"../../node_modules/filesaver.js/FileSaver":2}]},{},[3]);
