...
var FlareGameOverEventCall = (function () {
  function FlareGameOverEventCall() {
    _classCallCheck(this, FlareGameOverEventCall);
  }
  ...
  _createClass(FlareGameOverEventCall, null, [{
    ...
    value: function _calleEvent() {
      if ((0, _isUndefined2.default)(this._callEvent)) {
        return false;
      }
    ...
    value: function _getEventId() {
      if ((0, _isUndefined2.default)(this._eventId)) {
...
},{"lodash/lang/isUndefined":45}],52:[function(require,module,exports){
'use strict';
...
},{"lodash/collection/find":2,"lodash/lang/isUndefined":45}]},{},[51,52]);
